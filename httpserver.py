    ...
    def get(self):
        ...
        try:
            ...
            for row in rows:
                ...
                if row[5] == 0:  # SERVIZIO
                    strHtml = strHtml + "<input type='button' onclick='sendCommand(1,0)' value='START' style='margin:2%;' />"
                    strHtml = strHtml + "<input type='button' onclick='sendCommand(2,0)' value='STOP' style='margin:2%;' />"
                    strHtml = strHtml + "<input type='button' onclick='sendCommand(3,0)' value='RESTART' style='margin:2%;' />"
                else:  # SCRIPT
                    strHtml = strHtml + "<input type='button' onclick='sendCommand(1,1)' value='START' style='margin:2%;' />"
                    strHtml = strHtml + "<input type='button' onclick='sendCommand(2,1)' value='STOP' style='margin:2%;' />"
                    strHtml = strHtml + "<input type='button' onclick='sendCommand(3,1)' value='RESTART' style='margin:2%;' />"
...
def main():
    httpserver.serve(app, host='192.168.1.111', port='8080')
